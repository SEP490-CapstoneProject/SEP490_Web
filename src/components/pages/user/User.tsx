...
const jobData = [
  { company: "Tech Innovations Inc.", position: "Software Engineer", status: "Đồng ý", date: "2023-10-26", statusColor: "text-blue-500 bg-blue-50" },
  { company: "Global Solutions", position: "Product Manager", status: "Đang chờ", date: "2023-10-25", statusColor: "text-slate-500 bg-slate-100" },
  { company: "Creative Minds Agency", position: "UX Designer", status: "Đồng ý", date: "2023-10-24", statusColor: "text-blue-500 bg-blue-50" },
  { company: "Fintech Pioneers", position: "Financial Analyst", status: "Từ chối", date: "2023-10-23", statusColor: "text-red-500 bg-red-50" },
  { company: "HealthCare Systems", position: "Data Scientist", status: "Đồng ý", date: "2023-10-22", statusColor: "text-blue-500 bg-blue-50" },
];
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-8 shadow-sm">
        <h2 className="text-xl font-bold text-slate-800 dark:text-white mb-6">Lọc người dùng</h2>
